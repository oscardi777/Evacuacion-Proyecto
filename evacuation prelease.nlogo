...
to main-hall
  ...
  if ( pycor = 16 and ((pxcor >= -37 and pxcor <= -35) or (pxcor >= -29 and pxcor <= -22)))[                          ;  lungime hol =  35.5m => 63p    (muchie de sus)
    set pcolor black
    set object "wall"
  ]
  ...
  if ( (pycor > -32 and pycor <= 28) and pxcor = -22 ) [                         ;  lungime hol latime dreapta (muchie dreapta) = 29m      ----- latime perete stanga - perete dreapta = 4m
    set pcolor black
    set object "wall"
  ]
...
to classroom-doors
  ...
  if ( ( pycor > 9 and pycor <= 11 )  and pxcor = -22 ) [                           ; usa classroom-1-right
    set pcolor turquoise
    set object "intermediate-door"
  ]

  if ( ( pycor > 6 and pycor <= 8 )  and pxcor = -22 ) [                            ; usa classroom-2-right
    set pcolor turquoise
    set object "intermediate-door"
  ]

  if ( ( pycor > -14 and pycor <= -12 )  and pxcor = -22 ) [                        ; usa classroom-3-right
    set pcolor turquoise
    set object "intermediate-door"
  ]
end
...
to classroom-1-right
  if ( (pycor > 7 and pycor <= 28) and pxcor = -8)  [              ; muchie dreapta    ---- 19 patch =  9.5m
    set pcolor black
    set object "wall"
  ]
  if ( (pycor = 9) and (pxcor >= -21 and pxcor <= -8) ) [          ; perete de jos clasa1 (stanga sus) = latime clasa 1 = 14patches = 7m
    set pcolor black
    set object "wall"
  ]
  if ( (pycor = 29) and (pxcor >= -22 and pxcor <= -8) ) [         ; perete sus
    set pcolor black
    set object "wall"
  ]
  if ( pycor = 28 and pxcor > -17 and pxcor < -12) [               ; tabla
    set pcolor gray
    set object "wall"
  ]
end
...
to classroom-2-right
  if ( (pycor > -12 and pycor <= 7) and pxcor = -8)  [             ; muchie dreapta    ---- 19 patch =  9.5m
    set pcolor black
    set object "wall"
  ]
  if ( (pycor = -11) and (pxcor >= -22 and pxcor <= -8) ) [        ; perete de jos
    set pcolor black
    set object "wall"
  ]
  if ( pycor = 8 and pxcor > -17 and pxcor < -12) [                ; tabla
    set pcolor gray
    set object "wall"
  ]
end
...
to classroom-3-right
  if ( (pycor > -31 and pycor <= -12) and pxcor = -8)  [           ; muchie dreapta    ---- 19 patch =  9.5m
    set pcolor black
    set object "wall"
  ]
  if ( (pycor = -31) and (pxcor >= -21 and pxcor <= -8) ) [        ; perete de jos
    set pcolor black
    set object "wall"
  ]
  if ( pycor = -12 and pxcor > -17 and pxcor < -12) [              ; tabla
    set pcolor gray
    set object "wall"
  ]
end
...
to desks-classroom-1-right
   if (
    (pycor >= 15 and pycor < 25 and pycor mod 2 = 0) and ((pxcor = -20 or pxcor = -19) or (pxcor = -15 or pxcor = -14) or (pxcor = -10 or pxcor = -9)) or    ; lungimea bancilor este de 10patches sau 5m  (1m fiecare banca), latimea lor este de 2patches (1m)
  ...
  if (pycor = 28 and pxcor = -9) [ set pcolor teacher-seat-color ]
end
...
to desks-classroom-2-right
  ...
  if (pycor = 5 and pxcor = -15) [ set pcolor teacher-seat-color ]
end
...
to desks-classroom-3-right
  ...
  if (pycor = -15 and pxcor = -15) [ set pcolor teacher-seat-color ]
end
...
to top-left-second-corner-hall-exit
  if ( (pxcor = -39 and (pycor >= 21 and  pycor <= 31)) ) [                                                                           ; peretele dintre scari  (cele spre et1 si cele spre iesire)
    set pcolor black
    set object "wall"
  ]
  ...
  if ( (pycor >= 21 and pycor <= 24 and pycor mod 2 = 0) and (pxcor >= -38 and pxcor <= -36) ) [                     ; scari spre iesire principala
    set pcolor gray
  ]
...
to bottom-left-second-corner-hall-exit
  ...
  if ( (pycor <= -21 and pycor >= -29 and pycor mod 2 = 1) and (pxcor = -34 or pxcor = -33) ) [            ; scari spre et1
    set pcolor 7
    set object "wall"
  ]
...
to setup-obstacles
  ...
  if (((pxcor >= -41 and pxcor <= -36) and (pycor >= -30 and pycor <= 15)) or                                                                                                      ;left hall
    ((pxcor >= -41 and pxcor <= -34) and (pycor >= 17 and pycor <= 20))     or                                                                                                      ;backdoor-entrace-hall  (left stairs)
    ((pxcor >= -38 and pxcor <= -35) and (pycor >= 21 and pycor <= 30))  or                                                                                                           ;backdoor-entrace-hall  (right stairs)
    ((pxcor >= -32 and pxcor <= -27) and (pycor >= -30 and pycor <= 15))
  )
  [
    set outside false
